...
// Reclamar ticket
if (interaction.isButton() && interaction.customId === 'claim\_ticket') {
if (!interaction.member.roles.cache.has(STAFF\_ROLE\_ID)) {
...
// Cerrar ticket
if (interaction.isButton() && interaction.customId === 'close\_ticket') {
...
// Eliminar ticket
if (interaction.isButton() && interaction.customId === 'delete\_ticket') {
...
// Reabrir ticket
if (interaction.isButton() && interaction.customId === 'reopen\_ticket') {
await interaction.channel.setParent(TICKETS\_CATEGORY\_ID);
